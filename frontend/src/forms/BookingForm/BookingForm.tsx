...
import { createRoomBooking } from "../../apis/booking-api";
...
const BookingForm = ({ currentUser, paymentIntent }: Props) => {
  ...
  const { mutate: bookRoom, isLoading } = useMutation(createRoomBooking, {
    ...
    onError: () => {
      showToast({ message: "Error in Booking confirmation", type: "ERROR" });
    },
  });
  ...
  return (
    <form
      ...
      className="grid grid-cols-1 gap-5 rounded-lg border border-r-slate-300 p-5"
    >
