...
export const API_BASE_URL = import.meta.env.VITE_SERVER_BASE_URL || ""; //* in production we don't need server base url bcoz everything is served from backend itself
